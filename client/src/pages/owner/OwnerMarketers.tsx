...
import { Users, LayoutDashboard, Store, Wallet, BarChart3, Settings } from 'lucide-react';
...
export default function OwnerMarketers() {
  ...
  return (
    <div className={`min-h-screen bg-gray-50 ${isRTL ? 'rtl' : 'ltr'}`} dir={isRTL ? 'rtl' : 'ltr'}>
      <DashboardHeader title={isRTL ? 'إدارة المسوقين' : 'Manage Marketers'} icon={<Users className="w-5 h-5" />} onMenuToggle={setMenuOpen} menuOpen={menuOpen} />
      <div className="flex">
