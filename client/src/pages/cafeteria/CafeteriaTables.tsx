...
import { Table2, LayoutDashboard, UtensilsCrossed, Users, BarChart3, CreditCard, Settings } from 'lucide-react';
...
export default function CafeteriaTables() {
  ...
  return (
    <div className={`min-h-screen bg-gray-50 ${isRTL ? 'rtl' : 'ltr'}`} dir={isRTL ? 'rtl' : 'ltr'}>
      <DashboardHeader title={isRTL ? 'إدارة الطاولات' : 'Manage Tables'} icon={<Table2 className="w-5 h-5" />} onMenuToggle={setMenuOpen} menuOpen={menuOpen} />
      <div className="flex">
