...
import { UtensilsCrossed, LayoutDashboard, Table2, Users, BarChart3, CreditCard, Settings } from 'lucide-react';
...
export default function CafeteriaMenu() {
  ...
  return (
    <div className={`min-h-screen bg-gray-50 ${isRTL ? 'rtl' : 'ltr'}`} dir={isRTL ? 'rtl' : 'ltr'}>
      <DashboardHeader title={isRTL ? 'إدارة المنيو' : 'Manage Menu'} icon={<UtensilsCrossed className="w-5 h-5" />} onMenuToggle={setMenuOpen} menuOpen={menuOpen} />
      <div className="flex">
