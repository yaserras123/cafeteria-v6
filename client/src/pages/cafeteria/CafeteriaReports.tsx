...
import { BarChart3, LayoutDashboard, UtensilsCrossed, Table2, Users, CreditCard, Settings } from 'lucide-react';
...
export default function CafeteriaReports() {
  ...
  return (
    <div className={`min-h-screen bg-gray-50 ${isRTL ? 'rtl' : 'ltr'}`} dir={isRTL ? 'rtl' : 'ltr'}>
      <DashboardHeader title={isRTL ? 'التقارير' : 'Reports'} icon={<BarChart3 className="w-5 h-5" />} onMenuToggle={setMenuOpen} menuOpen={menuOpen} />
      <div className="flex">
