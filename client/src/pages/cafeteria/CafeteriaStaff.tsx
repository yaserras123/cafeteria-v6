...
import { Users, LayoutDashboard, UtensilsCrossed, Table2, BarChart3, CreditCard, Settings } from 'lucide-react';
...
export default function CafeteriaStaff() {
  ...
  return (
    <div className={`min-h-screen bg-gray-50 ${isRTL ? 'rtl' : 'ltr'}`} dir={isRTL ? 'rtl' : 'ltr'}>
      <DashboardHeader title={isRTL ? 'إدارة الموظفين' : 'Manage Staff'} icon={<Users className="w-5 h-5" />} onMenuToggle={setMenuOpen} menuOpen={menuOpen} />
      <div className="flex">
