...
import { Settings, LayoutDashboard, UtensilsCrossed, Table2, Users, BarChart3, CreditCard } from 'lucide-react';
...
export default function CafeteriaSettings() {
  ...
  return (
    <div className={`min-h-screen bg-gray-50 ${isRTL ? 'rtl' : 'ltr'}`} dir={isRTL ? 'rtl' : 'ltr'}>
      <DashboardHeader title={isRTL ? 'الإعدادات' : 'Settings'} icon={<Settings className="w-5 h-5" />} onMenuToggle={setMenuOpen} menuOpen={menuOpen} />
      <div className="flex">
