...
import { ShoppingCart, LayoutDashboard, Users, BarChart3 } from 'lucide-react';
...
export default function ManagerOrders() {
  ...
  return (
    <div className={`min-h-screen bg-gray-50 ${isRTL ? 'rtl' : 'ltr'}`} dir={isRTL ? 'rtl' : 'ltr'}>
      <DashboardHeader title={isRTL ? 'الطلبات' : 'Orders'} icon={<ShoppingCart className="w-5 h-5" />} onMenuToggle={setMenuOpen} menuOpen={menuOpen} />
      <div className="flex">
