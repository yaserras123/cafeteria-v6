...
import { Users, LayoutDashboard, Wallet, BarChart3 } from 'lucide-react';
...
export default function MarketerDownlines() {
  ...
  return (
    <div className={`min-h-screen bg-gray-50 ${isRTL ? 'rtl' : 'ltr'}`} dir={isRTL ? 'rtl' : 'ltr'}>
      <DashboardHeader title={isRTL ? 'أبنائي' : 'My Downlines'} icon={<Users className="w-5 h-5" />} onMenuToggle={setMenuOpen} menuOpen={menuOpen} />
      <div className="flex">
