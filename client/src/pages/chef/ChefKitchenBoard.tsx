...
export default function ChefKitchenBoard() {
  ...
  return (
    <div className={`min-h-screen bg-slate-900 text-white ${isRTL ? 'rtl' : 'ltr'}`} dir={isRTL ? 'rtl' : 'ltr'}>
      <DashboardHeader showBackButton={true} showHomeButton={true} title={isRTL ? 'لوحة تحكم المطبخ' : 'Kitchen Display System'} onMenuClick={() => setMenuOpen(true)} showBackButton={true} showHomeButton={true} />
