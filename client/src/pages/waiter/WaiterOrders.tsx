...
import { ShoppingCart, LayoutDashboard, Table2, Clock, CheckCircle, AlertCircle } from 'lucide-react';
...
export default function WaiterOrders() {
  ...
  const pendingOrders = orders.filter(o => !['completed'].includes(o.status)).length;
