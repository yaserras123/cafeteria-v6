...
import { Table2, LayoutDashboard, ShoppingCart } from 'lucide-react';
...
export default function WaiterTables() {
  ...
  return (
    <div className={`min-h-screen bg-gray-50 ${isRTL ? 'rtl' : 'ltr'}`} dir={isRTL ? 'rtl' : 'ltr'}>
      <DashboardHeader title={isRTL ? 'الطاولات' : 'Tables'} icon={<Table2 className="w-5 h-5" />} onMenuToggle={setMenuOpen} menuOpen={menuOpen} />
      <div className="flex">
